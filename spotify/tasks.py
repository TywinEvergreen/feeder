...
def get_new_albums():
    ...
    for artist in Artist.objects.all():
        latest_album = SPOTIFY.artist_albums(artist.spotify_id, limit=1, album_type='album')['items']
        latest_single = SPOTIFY.artist_albums(artist.spotify_id, limit=1, album_type='single')['items']
