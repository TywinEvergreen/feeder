...
from subscription.tests.factories import (
    ArtistSubscriptionFactory,
    ChannelSubscriptionFactory,
)
...
class ArtistSubscriptionViewSetTest(APITestCase):
    ...
    def test_create_artist_subscription(self):
        ...
        response = self.client.post(url, {"artist": self.artist.pk})
    ...
    def test_delete_artist_subscription(self):
        self.client.force_login(self.user)
        url = reverse(
            "subscription:artist-subscription-detail",
...
class ChannelSubscriptionViewSetTest(APITestCase):
    ...
    def test_create_channel_subscription(self):
        ...
        response = self.client.post(url, {"channel": self.channel.pk})
    ...
    def test_delete_artist_subscription(self):
        self.client.force_login(self.user)
        url = reverse(
            "subscription:channel-subscription-detail",
            kwargs={"pk": self.subscription.pk},
        )
        response = self.client.delete(url)
